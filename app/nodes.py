...
_analyze_prompt = ChatPromptTemplate.from_messages(
    [
        (
            "system",
            """You are a senior software engineer estimating ticket complexity.
...
_recommend_prompt = ChatPromptTemplate.from_messages(
    [
        (
            "system",
            """You are a senior software engineer providing actionable recommendations.
    ...
    result = await _recommend_chain.ainvoke(
        {
            ...
            "similar_tickets": state.analyze_state.similar_ticket_ids
            if state.analyze_state
            else [],
        }
    )
